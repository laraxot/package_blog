...
namespace XRA\Blog\Controllers\Admin\Blog\Container0\Container1\Container2;
...
class Container3Controller extends Controller{
	//use CrudTrait;
	...
	public function getController(){
		...
		if(isset($container3)){
			if(is_object($container3)){
				$controller.='\\'.studly_case($container3->type);
			}else{
				$controller.='\\'.studly_case($container3);
			}
